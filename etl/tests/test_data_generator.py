...
from src.data_generator import generate_customers, generate_products, generate_sales, save_data, DataGenerationError
...
@patch("src.data_generator.pd.DataFrame.to_csv")
@patch("src.data_generator.os.makedirs")
@patch("src.data_generator.logger")
def test_save_data(mock_logger, mock_makedirs, mock_to_csv):
...
@patch("src.data_generator.save_data")
